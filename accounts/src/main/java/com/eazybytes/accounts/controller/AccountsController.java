...
public class AccountsController {
    ...
    public ResponseEntity<String> getBuildInfo() throws TimeoutException {
        ...
        */
        ...
        // 테스트 1) 오류 즉시 Circuit Breaker가 Open 상태로 전환됨
        // throw new RuntimeException("Intentional Exception to open Circuit Breaker");

        // 테스트 2) TimeoutException을 발생시켜 재시도와 Circuit Breaker 동작을 확인합니다.
